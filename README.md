...
| Create FE AUTH                       |    H     |     3 hrs      |      TBD      |     TBD     |
| Create Insight FE-CRUD               |    H     |     3 hrs      |     2hrs      |     TBD     |
| Create Mood FE-CRUD                  |    H     |     3 hrs      |      TBD      |     TBD     |
| Create Home Page                     |    H     |     2 hrs      |      TBD      |     TBD     |
| Create Community Page                |    H     |      2 hr      |      TBD      |     TBD     |
| Create Settings Page                 |    L     |      1 hr      |     1.5hr     |     TBD     |
| Create, refactor and debug Dark Mode |    L     |      1 hr      |     3 hrs     |     TBD     |
| TOTAL                                |          |     50 hrs     |     27hrs     |     TBD     |
